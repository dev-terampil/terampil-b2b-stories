...
function GeneralFormCard(props) {
  ...
  return /* @__PURE__ */ _react2.default.createElement(
    ...
    /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center justify-end gap-[12px] bg-[#F9FAFB] p-[12px_20px]` }, /* @__PURE__ */ _react2.default.createElement(
      ...
      {
        smaller: true,
        className: `!outline-none !bg-transparent !border-transparent !text-[14px] !p-[8px_24px] !text-[#A1AFC0]`,
        onClick: props.onCancel
      },
      "Cancel"
    ), /* @__PURE__ */ _react2.default.createElement(
      ...
      {
        smaller: true,
        className: `!outline-none !bg-[#0066B9] !text-white !text-[14px] !p-[8px_24px]`,
        loading: props.loadingSave,
        onClick: props.onSave
      },
      "Save"
...
// src/new-design/general/ImageUploader.tsx


// src/new-design/b64-images/UserFramePNG.ts
var UserFramePNG = "data:image/png;base64,";

// src/new-design/b64-images/CameraBlueSVG.ts
var CameraBlueSVG = "data:image/svg+xml;base64,";

// src/new-design/general/ImageUploader.tsx
function ImageUploader(props) {
  var _a;
  const uploader_ref = _react.useRef.call(void 0, null);
  const image_ref = _react.useRef.call(void 0, null);
  function inputFileChange(e) {
    if (e.target.files && e.target.files.length > 0) {
      props.onFileChange && props.onFileChange(e.target.files[0]);
      image_ref.current.src = URL.createObjectURL(e.target.files[0]);
      image_ref.current.onload = function() {
        URL.revokeObjectURL(image_ref.current.src);
      };
    }
  }
  return /* @__PURE__ */ _react2.default.createElement(
    "div",
    {
      onClick: () => {
        var _a2;
        return (_a2 = uploader_ref.current) == null ? void 0 : _a2.click();
      },
      className: `relative h-[64px] w-[64px] cursor-pointer ${props.containerClassName || ""}`
    },
    /* @__PURE__ */ _react2.default.createElement(
      "div",
      __spreadProps(__spreadValues({}, props), {
        className: `relative w-full h-full rounded-full overflow-hidden cursor-pointer ${props.className || ""}`
      }),
      /* @__PURE__ */ _react2.default.createElement(
        "img",
        {
          ...
          src: (_a = props.imageUrl) != null ? _a : UserFramePNG
        }
      ),
      /* @__PURE__ */ _react2.default.createElement(
        "input",
    ...
    /* @__PURE__ */ _react2.default.createElement(
      "img",
      {
        className: `w-[16px] h-[16px] object-contain absolute z-[2] right-0 bottom-0`,
        src: CameraBlueSVG
      }
    )
  );
...
// src/new-design/general/AssistantChatHistory.tsx

function AssistantChatHistory(props) {
  var _a;
  return /* @__PURE__ */ _react2.default.createElement("div", { className: `h-full flex flex-col gap-3 w-[250px] bg-[#F8FCFF] border-r border-r-[1.5px] p-[24px_16px] border-r-[#EAEFF5] font-[Poppins] overflow-auto ` }, /* @__PURE__ */ _react2.default.createElement(
    "div",
    {
      className: `border-l-transparent text-[#8DA6C4] p-[0px_7px] cursor-pointer border-l border-l-[5px] font-medium rounded-[5px] text-[15px] pr-[12px] mb-4`
    },
    "Conversations"
  ), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex flex-col gap-3 flex-1` }, ((_a = props.data) != null ? _a : []).map((item, i) => /* @__PURE__ */ _react2.default.createElement("div", { key: item.id }, /* @__PURE__ */ _react2.default.createElement(
    "a",
    {
      href: item.url,
      className: `${item.id == props.activeID ? "border-l-[#0066B9] text-[#0066B9] bg-[#E7F2FB] p-[10px_7px] font-medium" : "border-l-transparent text-[#8DA6C4] p-[0px_7px]"} cursor-pointer border-l border-l-[5px] rounded-[5px] font-[Poppins] text-[13px] block w-full whitespace-nowrap truncate`
    },
    item.label
  )))));
}

// src/new-design/general/AgendaSideCard.tsx

function AgendaSideCard(props) {
  return /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-white rounded-[12px] border border-[2px] border-[#F1F5F9] p-[12px_18px] font-[Poppins] flex flex-col gap-1` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `font-medium` }, "Internal Meeting"), /* @__PURE__ */ _react2.default.createElement("div", { className: `` }, "Meeting with internal team - Discuss Sales Target"), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center justify-between mt-2` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#8DA6C4] text-[14px]` }, "09:00 - 10:00, 10 Des 2024"), /* @__PURE__ */ _react2.default.createElement("div", { className: `border border-px border-[#FF4343] bg-[#FFEFEF] rounded-[6px] p-[4px_9px] text-[#FF4343] font-medium text-[13px]` }, "Urgent")));
}

// src/new-design/general/KeyResultSideCard.tsx

function KeyResultSideCard(props) {
  return /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-white rounded-[12px] border border-[2px] border-[#F1F5F9] font-[Poppins] flex flex-col overflow-hidden` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `p-[12px_18px] flex flex-col gap-2` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `font-medium` }, "Increase Product A Revenue"), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex flex-col gap-0 text-[14px]` }, "Meeting with internal team - Discuss Sales Target"), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center justify-between` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#8DA6C4] text-[14px]` }, "09:00 - 10:00, 10 Des 2024"), /* @__PURE__ */ _react2.default.createElement("div", { className: `border border-px border-[#FF4343] bg-[#FFEFEF] rounded-[6px] p-[4px_9px] text-[#FF4343] font-medium text-[13px]` }, "Behind"))), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#0066B9] border-t border-t-[2px] border-t-[#F1F5F9] text-center p-2 text-[14px] font-medium` }, "Approve"));
}

// src/new-design/general/TaskSideCard.tsx

function TaskSideCard(props) {
  return /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-white rounded-[12px] border border-[2px] border-[#F1F5F9] font-[Poppins] flex flex-col overflow-hidden` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `p-[12px_18px] flex flex-col gap-2` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `font-semibold` }, "Follow up 10 leads"), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex flex-col gap-0 text-[15px]` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#8DA6C4]` }, "Related to KR:"), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#0066B9] underline` }, "Meeting with internal team - Discuss Sales Target")), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center justify-between` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `flex flex-col gap-0` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#8DA6C4] text-[14px]` }, "Deadline:"), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[14px]` }, "10 Des 2024 - 2 day ago")), /* @__PURE__ */ _react2.default.createElement("div", { className: `border border-px border-[#FF4343] bg-[#FFEFEF] rounded-[6px] p-[4px_9px] text-[#FF4343] font-medium text-[13px]` }, "High"))), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#0066B9] underline border-t border-t-[2px] border-t-[#F1F5F9] text-center p-2 text-[14px] font-medium` }, "See Detail"));
}
