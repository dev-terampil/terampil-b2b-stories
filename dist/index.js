...
function _Popup(props, ref) {
  ...
  return /* @__PURE__ */ _react2.default.createElement(
    "div",
    {
      ...
      className: `fixed top-0 left-0 w-screen h-screen z-[999999] bg-[#0005] p-[12px] flex flex-col ${props.parentClassName || ""}`
    },
    /* @__PURE__ */ _react2.default.createElement(
      "div",
      __spreadProps(__spreadValues({}, props), {
...
function AgendaSideCard(props) {
  return /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-white rounded-[12px] border border-[2px] border-[#F1F5F9] p-[12px_18px] font-[Poppins] flex flex-col gap-1` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `font-medium text-[14px]` }, "Internal Meeting"), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[14px]` }, "Meeting with internal team - Discuss Sales Target"), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center justify-between mt-2` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[#8DA6C4] text-[13px]` }, "09:00 - 10:00, 10 Des 2024"), /* @__PURE__ */ _react2.default.createElement("div", { className: `border border-px border-[#FF4343] bg-[#FFEFEF] rounded-[6px] p-[4px_9px] text-[#FF4343] font-medium text-[13px]` }, "Urgent")));
}
