...
function OKRTreeNode(props) {
  ...
  )), /* @__PURE__ */ _react2.default.createElement("div", { className: `flex flex-col gap-1` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center gap-2 bg-[#E9F5FF] p-[4px_10px] rounded-[8px]` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-[#0066B9] w-[8px] h-[8px] rounded-full` }), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[14px] font-medium` }, props.data.okr_target)), props.data.cascading_percentage && /* @__PURE__ */ _react2.default.createElement("div", { className: `flex items-center gap-2 bg-[#E9FFF3] p-[4px_10px] rounded-[8px]` }, /* @__PURE__ */ _react2.default.createElement("div", { className: `bg-[#00EB61] w-[8px] h-[8px] rounded-full` }), /* @__PURE__ */ _react2.default.createElement("div", { className: `text-[14px] font-medium` }, "90%"))));
}
